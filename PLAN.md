...
| `<item type="…">` for any non-string type (`color`, `bool`, `dimen`, `integer`, `style`) | **silently ignored** — presentation resources, genuinely not ours; same rule §4.3's multi-file check applies | `item-type-nonstring-ignored` |
