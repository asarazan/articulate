...
- **A `feature/showcase-core`** — skeleton, catalogs, wrapper, `:i18n` strings (15.2 verbatim, all 5 locales), `:shared` (15.3 verbatim + commonTest), catalog generated & committed, `verifyStrings` clean.
